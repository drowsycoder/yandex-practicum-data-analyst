...
for i in range(len(data)):
    emojixpress_total += data[i][1]
emojixpress_mean = emojixpress_total / list_len

instagram_total = 0
for i in range(len(data)):
    instagram_total += data[i][2]
instagram_mean = instagram_total / list_len

twitter_total = 0
for i in range(len(data)):
    twitter_total += data[i][3]
twitter_mean = twitter_total / list_len
