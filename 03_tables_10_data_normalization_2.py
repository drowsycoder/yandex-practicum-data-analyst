...
emojixpress_mean = emojixpress_sum / data_len
instagram_mean = instagram_sum / data_len
twitter_mean = twitter_sum / data_len

for i in range(data_len):
    data[i].append(
        data[i][1] / emojixpress_mean + data[i][2] / instagram_mean + data[i][3] / twitter_mean
    )
